...
<html>
    ...
    <body>
       ...
       <div class="container">
            <br>
            <br>
           <center> <h1 style="color:Blue"><b>BOOKING List User</b></h1></center>
            <br>
            <br>
            <form action="List_booking_user.jsp" method="POST">
<!--                <div class="row">
                <div class="col-sm-8">
  ...
  int counter=1;
    String sql="";
           ...
           if(Search!=null)
           {
           sql="select * from My_Booking where driver_name='"+txt_name+"'";
           }
           else 
           {
