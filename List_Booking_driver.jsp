...
<html>
    <head>
        ...
        <title>List My booking_status</title>
    ...
    <body>
       ...
       <div class="container">
            <br>
            <br>
           <center> <h1 style="color:Blue"><b>My Booking Status</b></h1></center>
            <br>
            <br>
            <form action="List_Booking_driver.jsp" method="POST">
                <div class="row">
                <div class="col-sm-8">
  ...
  int counter=1;
    String sql="";
           ...
           String Search=request.getParameter("btn_save");
            ...
            if(Search!=null)
           {
           sql="select * from My_Booking where us_id='"+Regid+"'";
           }
           else 
           {
           sql="select * from My_Booking  where us_id='"+session.getAttribute("us_id")+"' ORDER BY status='Pending'  DESC";
           }
       try
       {
...
%>
                 ...
                 <form action="Pending_Payment" method="POST">
        <td>
             <input value="<%=rs.getString("Booking_id")%>" style=" border:solid black" onkeypress="javascript:return isNumbet(event)" type="hidden" name="txt_id" placeholder="Booking id" class="form-control">
             <input type="hidden"value="<%=rs.getString("total_amount")%>"id="totalamount" onkeypress="javascript:return isNumber(event)"  style=" border:solid black;" placeholder="Amount" name="txt_amount" onkeyup="cal()" class="form-control">
            <%
...
%>
              <input type="submit" class="btn btn-success" name="btn_save" value="Pay">
              <%
}              
%>
             <br>
