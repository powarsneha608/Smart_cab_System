<%-- 
    Document   : UPI
    Created on : 16 Apr, 2023, 3:06:13 PM
    Author     : Snehal
--%>
            ...
            <div class="col-sm-3"></div>
             <div class="col-sm-6">
                 ...
                 <div class="container">
                      <div class="row">
                           <div class="col-sm-3">
                      <img src="img/UPI_Logo.png" height="100" width="200">
                          </div>
                          <div class="col-sm-9">
                              <br>
                                 <center><h1><b>Unified Payments Interface</b></h1></center>
                          </div>
...
<!--                         <div class="col-sm-4">
                  ...
                  <div class="col-sm-6">
                             <label><b>UPI no</b></label><span style="color:red">*</span>
                             <input  required="" style=" border:solid black;" onkeypress="javascript:return isNumber(event)" type="text" name="txt_cno" placeholder="Enter card no" class="form-control">
                         </div>
                     </div>
                     <br>         
