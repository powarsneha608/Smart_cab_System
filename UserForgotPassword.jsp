<%-- 
    ...
    Created on : 21 Feb, 2023, 10:14:50 PM
    Author     : Snehal
--%>
...
input[type=text],[type=Password]
{
 ...
 input[type=save],[type=cancle]
 {
    ...
    <body>
        ...
        <form action="Forgot_Password_user" method="POST">
            ...
            <div class="col-sm-3"></div>
             <div class="col-sm-6">
                 ...
                 <div class="container">
                     <div class="row">
                         <div class="col-sm-12">
                     <center><h1 style="color:blue"><b> User Forgot Password</b></h1></center>
                     ...
                     <br>
                         ...
                         <div class="col-sm-12 ">
                             ...
                             <input  required="" maxlength="12" minlength="6" type="password" id="txtPassword" name="txt_pass" placeholder="***************"  class="form-control">
                         </div>
                         <div class="col-sm-12 ">
                             <label><b>Conform Password</b></label><span style="color:red">*</span>
                             <input  required="" minlength="6" maxlength="12"type="password" id="txtConfirmPassword" name="txt_cpass" placeholder="***************"  class="form-control">
                         </div>
                     </div>
                     <br>
                     <br>
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-5">
                          <br>
                             <input type="submit" id="btn" name="btn_save" class="btn btn-primary form-control" value="Save">
                         </div>
                      <br>
                      ...
                      <div class="col-sm-5">
                          <br>
                             ...
                             <input type="submit"  name="btn_save" class="btn btn-danger form-control" value="Cancle">
                      </div>
                      <div class="col-sm-1"></div>
                      <br>  
                      ...
                      <div class="col-sm-5"></div>
                         ...
                         <label><b><a href="userLogin.jsp"> Back to Login Page </a></b></label>
