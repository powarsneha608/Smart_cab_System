<%-- 
    Document   : view_Rules
    Created on : 20 Mar, 2023, 11:41:06 PM
    Author     : Snehal
--%>
           ...
           String sql="select * from rules";
            ...
            %>
                ...
                <div class="col-sm-12">
                    ...
                    <h2 style="color:black"><b>Rules : </b><%=rs.getString("Rules")%></h2>
<!--                    <hr style="height:1px;border-width:0;color:white;background-color:black">-->
                    <h4 style="color:gray"><b>Description : </b><%=rs.getString("Description")%></h4>
                    <br>
                    
                    <!--<center> <a href="view_Rules.jsp"> <input type="submit" name="btn_save" value="Read More" class="btn btn-success"></a></center>-->
                    <br>
...
System.out.println(ex.toString());
              ...
              <div class="row">
                   ...
                   <div class="col-sm-4">
                       <form action="view_Rules" method="POST">
