<%-- 
    Document   : Vahical_Type
    Created on : 12 Apr, 2023, 3:14:58 PM
    Author     : Snehal
--%>
     ...
     <%@include file="Header_Driver.jsp"%>
        ...
        <div class="container">
            ...
            <div class="col-sm-2">
             ...
             <div class="col-sm-8">
                 <br>
            <center><h1 style="color:blue"><b>Choose Your Cab Type</b></h1></center>
            
            <br>
            <br>
             <div class="Addauto">
              <form action="Vahical_Type" method="POST">
                <div class="row">
                    <div class="col-sm-4">
