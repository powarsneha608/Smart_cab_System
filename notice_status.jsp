<%-- 
    Document   : notice_status
    Created on : 1 May, 2023, 10:26:58 AM
    Author     : Snehal
--%>
...
<html>
    <head>
        ...
        <title>view status Notice</title>
...
////           else 
////           {
////          sql="select * from notice where notice_no='"+session.getAttribute("notice_no") +"'";
////           }
      try
      {
      Class.forName("com.mysql.jdbc.Driver");
           ...
           String  sql="select * from notice  where notice_no='"+session.getAttribute("notice_no")+"' ";
...
<!--      <div class="row">
           ...
           <input type="submit" name="btn_save" value="Open" class="btn btn-primary" class="form-control">
            </div>
         ...
         <div class="col-sm-4"></div>
                  ...
                  <div class="col-sm-12">
                      <input  value="<%=rs.getString("notice_no")%>"  type="hidden" name="notice_no">
                        <h2>#<%=rs.getString("notice_no")%></h2>
                        <h2 style="color:black"><%=rs.getString("notice_title")%></h2>
                         <p>Date :<%=rs.getString("ndate")%></p>
                        <p>Message : <%=rs.getString("message")%></p>
                         <p>Description : <%=rs.getString("Description")%></p>
                         <br>
                        
                             <center>    <a href="view_Notice.jsp"class="btn btn-success">Back</a></center>
