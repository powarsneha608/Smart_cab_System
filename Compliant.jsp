<%-- 
    Document   : Compliant
    Created on : 14 Feb, 2023, 10:55:50 PM
    Author     : Snehal
--%>
             ...
             <div class="col-sm-6">
                 ...
                 <div class="container">
                     <div class="row">
                          ...
                          <div class="col-sm-9">
                              <br>
                     <center><h1><b>User Compliant</b></h1></center>
                     ...
                     <hr style="height:2px;border-width:0;color:white;background-color:black">
                         ...
                         <div class="col-sm-6 ">
                             ...
                             <input  required="" style=" border:solid black;"onkeypress="javascript:return isString(event)" type="text" value="<%=session.getAttribute("fullname")%>"name="txt_name" placeholder="Enter Name" class="form-control">
                         </div>
                     </div>
                     <br>
                     <div class="row">
                         <div class="col-sm-6">
                             ...
                             <input  required="" style=" border:solid black;"type="Email" name="txt_email"value="<%=session.getAttribute("Email")%>" placeholder="Enter Email id"  class="form-control">
                         </div>
                         <div class="col-sm-6 ">
                             <label><b>Contact</b></label><span style="color:red">*</span>
                             <input  required="" style=" border:solid black;"value="<%=session.getAttribute("contact")%>"onkeypress="javascript:return isNumber(event)"maxlength="10" type="text"    name="txt_number" placeholder="Enter contact number" class="form-control">
                         </div>
                     </div>
                     <br>
                     ...
                     <div class="row">
                         <div class="col-sm-6">
                            ...
                            <textarea  required=""  style=" border:solid black;" name="message" class="form-control" placeholder="Enter Message (in 100 words)" rows="2" cols="15"></textarea>
                             </div>
                         <div class="col-sm-6">
