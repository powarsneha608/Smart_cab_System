<%-- 
    Document   : Update_User_Registration
    Created on : 27 Apr, 2023, 10:37:29 PM
    Author     : Snehal
--%>
...
<html>
    <head>
        ...
        <title>Update_User_Registration</title>
                     ...
                     <hr style="height:2px;border-width:0;color:white;background-color:black">
                         ...
                         <div class="col-sm-4">
                          ...
                          <div class="col-sm-4">
                             ...
                             <textarea  required="" style="border:solid black;" name="address" class="form-control"onkeypress="Javascript:return isAlphanumeric(event)" placeholder="Enter Address" rows="1" cols="15"><%=request.getParameter("address")%></textarea>
                         </div>
                          <div class="col-sm-4">
                     ...
                     <br>         
                      <div class="row">
                         <div class="col-sm-4">
                            ...
                            <input value="<%=request.getParameter("contact")%>" required=""  style="border:solid black;" type="text" id="txt_no" name="txt_no"   maxlength="10"  placeholder="Enter Contact" class="form-control">
                         </div>
                           <div class="col-sm-4">
