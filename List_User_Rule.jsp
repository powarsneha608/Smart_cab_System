<%-- 
    Document   : List_User_Rule
    Created on : 25 Apr, 2023, 8:57:38 PM
    Author     : Snehal
--%>
        ...
        <%@include file="Header_Admin.jsp"%>
          <div class="container">
           ...
           <center> <h1 style="color:Blue"><b>Rules List</b></h1></center>
            <br>
            <br>
<!--            <form action="List_User_Rule.jsp" method="POST">-->
<!--                <div class="row">
                <div class="col-sm-10">
   ...
   int counter=1;
       ...
       try
       {
           ...
           <tbody>
            <tr>
          <form action="update_rules_User.jsp" method="POST">
